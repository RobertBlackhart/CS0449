...
#include "mymalloc.h"   // protoypes of your worst fit version of malloc and your free function
...
void * base = NULL;  // init  once at start of program then do  not ever modify this value
...
int main()
{
        base = sbrk(0); // added by Hoffman to make it work with other files
